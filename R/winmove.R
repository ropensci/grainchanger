#'Calculate the value of a given function for each cell, within a given neighbourhood. Note that dimensions of the moving window will be floor(radius/res)*2 + 1
#'
...
#'@param type The shape of the moving window: `circle` or `rectangle`
#'@param fn The function to apply 
#'@param ... further arguments passed to or from other methods
#'@return A raster with the moving window values calculated
#'@export

winmove <- function(dat, radius, type=c("circle", "rectangle"), fn, ...) {
